            ...
            <el-form label-width="70px" size="small">
                <el-row :gutter="20">
                    ...
                    <el-col :span="10">
                        ...
                        <el-button type="primary" @click="next()" :disabled="choice == size">下一题</el-button>
                        <el-button type="primary" @click="showAnswer = !showAnswer">查看答案</el-button>
                        <el-button type="primary" @click="addExp">加入错题</el-button>
                    </el-col>
                </el-row>
            </el-form>
        </div>
    ...
    methods: {
        getCourseList() {
            api.getCourseList(1, 100, null).then(res => {
                ...
                // this.courseList = res.data.classList;
        ...
        fetchData() {
            this.loading = true;
            api.getPracticeQestion(this.data).then(res => {
                this.loading = false;
        ...
        addExp() {
            api.addExp(this.questionList[this.choice]).then(res => {
                if(res.code == 200) {
